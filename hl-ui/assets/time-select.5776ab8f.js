...
<\/script>
`},{default:v(()=>[E]),_:1},8,["demos"]),O,z,H,I,s(d,{fs:"",demos:p(n),"component-id":e,"path-name":"time-select/time-formats","source-code":`<template>
  <hl-time-select
    v-model="value"
    start="00:00"
    step="00:30"
...
<\/script>
`},null,8,["demos"]),M,U,s(d,{fs:"",demos:p(n),"component-id":e,"path-name":"time-select/time-range","source-code":`<template>
...
<\/script>
`},null,8,["demos"]),k]),s(u)],64)}}};export{A as default};
