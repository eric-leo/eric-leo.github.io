...
<\/script>
`},null,8,["demos"]),R,V,x(a,{fs:"",demos:D(r),"component-id":u,"path-name":"virtual-table/loading","source-code":`<template>
  <hl-virtual-table
    :cols="cols"
    :data="tableData"
    :total="200"
...
<\/script>
`},null,8,["demos"]),L]),x(e)],64)}}};export{M as default};
