...
<\/script>
`},{default:a(()=>[O]),_:1},8,["demos"]),q,z,n(i,{fs:"",demos:h(r),"component-id":e,"path-name":"time-picker/is-range","source-code":`<template>
  <hl-row align="items-center" gap="var(--xl)">
    <hl-col span="lg:col-10">
      <hl-time-picker
        v-model="value2"
...
<\/script>
`},null,8,["demos"]),N]),n(c)],64)}}};export{L as default};
