...
<\/script>
`},{default:l(()=>[Ot]),_:1},8,["demos"]),zt,$t,a(u,{fs:"",demos:_(n),"component-id":o,"path-name":"simple-table/size","source-code":`<template>
  <hl-select v-model="value" clearable placeholder="\u8BF7\u9009\u62E9" class="m-b-md">
    <template v-for="item in options">
      <hl-option v-if="item.divider" :key="item.value" divider />
      <hl-option
...
const tableData = ref([
  ...
  { id: 4, name: '\u674E\u56DB2', sex: '\u7537', org: '\u4E2D\u56FD\u7CFB\u7EDF', des: '\u6765\u81EA\u4E2D\u56FD' },
  { id: 5, name: '\u674E\u56DB3', sex: '\u7537', org: '\u4E2D\u56FD\u7CFB\u7EDF', des: '\u6765\u81EA\u4E2D\u56FD' },
  { id: 6, name: '\u674E\u56DB4', sex: '\u7537', org: '\u4E2D\u56FD\u7CFB\u7EDF', des: '\u6765\u81EA\u4E2D\u56FD' },
])
const cols = ref([
  { title: '#', slotName: 'tableIndex' },
  { title: '\u7528\u6237\u540D', prop: 'name' },
...
<script setup lang="ts">
import { ref } from 'vue'
import { HlSimpleTable } from 'helper-ui'
...
<\/script>
`},{default:l(()=>[Nn]),_:1},8,["demos"]),Sn]),a(d)],64)}}};export{$n as default};
