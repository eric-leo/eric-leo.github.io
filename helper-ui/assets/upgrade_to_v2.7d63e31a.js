...
</code></pre><h4 id="dang-ran-wo-men-reng-ran-tui-jian-ni-shi-yong-scss-pei-zhi-wen-jian-jin-xing-ji-chu-ding-yi"><a class="header-anchor" href="#dang-ran-wo-men-reng-ran-tui-jian-ni-shi-yong-scss-pei-zhi-wen-jian-jin-xing-ji-chu-ding-yi"></a> \u5F53\u7136\uFF0C\u6211\u4EEC\u4ECD\u7136\u63A8\u8350\u4F60\u4F7F\u7528 Scss \u914D\u7F6E\u6587\u4EF6\u8FDB\u884C\u57FA\u7840\u5B9A\u4E49\uFF1A</h4><p>\u56E0\u4E3A helper \u7684\u6837\u5F0F\u90FD\u662F\u81EA\u52A8\u751F\u6210\u7684\uFF0C\u4F60\u53EA\u9700\u8981\u64CD\u7EB5 config.scss \u6587\u4EF6\u5373\u53EF\u5BF9\u6574\u4F53 UI \u8FDB\u884C\u6DF1\u5EA6\u4FEE\u6539\u3002\u5C31\u7B97\u5BF9 scss \u4E0D\u591F\u719F\u7EC3\u4E5F\u5B8C\u5168\u6CA1\u6709\u95EE\u9898\u3002</p>`,3),N=n(" config.scss "),M=e(`<pre><code class="hljs language-scss"><span class="hljs-comment">//--\u80CC\u666F\u8272</span>
<span class="hljs-variable">$conf_bg_color</span>: (
...
</code></pre><h2 id="xin-zeng-zu-jian-ji-bian-liang"><a class="header-anchor" href="#xin-zeng-zu-jian-ji-bian-liang"></a> \u65B0\u589E\u7EC4\u4EF6\u7EA7\u53D8\u91CF</h2><p>\u6BCF\u4E2A\u7EC4\u4EF6\u90FD\u5305\u542B\u4E86\u72EC\u7ACB\u7684\u53D8\u91CF\uFF0C\u4F60\u53EF\u4EE5\u5BF9\u5B83\u7684\u6837\u5F0F\u8FDB\u884C\u6DF1\u5EA6\u8C03\u6574\uFF0C\u4E5F\u53EF\u4EE5\u50CF\u4E0A\u9762\u7684\u4ECB\u7ECD\u90A3\u6837\uFF0C\u901A\u8FC7\u4E00\u4E2A\u5355\u72EC\u7684 css \u6587\u4EF6\u6765\u5BF9\u5168\u5C40\u7EC4\u4EF6\u8FDB\u884C\u6837\u5F0F\u5B9A\u4E49\u3002</p>`,3),H=t("pre",null,[t("code",{class:"html"},`<hl-button
  style="
    --button-radius: 8px;
...
<\/script>
`)],-1),I=t("h2",{id:"pei-zhi-wen-jian-de-bian-hua"},[t("a",{class:"header-anchor",href:"#pei-zhi-wen-jian-de-bian-hua"}),n(" \u914D\u7F6E\u6587\u4EF6\u7684\u53D8\u5316")],-1),P=t("p",null,[n("config.scss \u914D\u7F6E\u6587\u4EF6\u5DF2\u7ECF\u5B8C\u5168\u91CD\u6784\u4E3A "),t("a",{href:"https://sass-lang.com/documentation/values/maps"},"Scss:Maps"),n(" \u5F62\u5F0F\uFF0C \u6240\u4EE5\u4F60\u9700\u8981\u5C06\u4F60\u9879\u76EE\u7684 config \u91CC\u5BF9\u5E94\u7684\u503C\u5168\u90E8\u8FC1\u79FB\u81F3\u65B0\u7684\u914D\u7F6E\u6587\u4EF6\u3002")],-1),R=n(" v1x \u7248\u672C config.scss "),T=e(`<pre><code class="hljs language-scss"><span class="hljs-variable">$tagRadius</span>: <span class="hljs-variable">$pageRadius-Md</span> !default;
...
</code></pre>`,1),L=n(" v2x \u7248\u672C config.scss "),G=e(`<pre><code class="hljs language-scss"><span class="hljs-variable">$conf_tag</span>: (
...
</code></pre><h2 id="chi-cun-bian-liang-xiu-gai"><a class="header-anchor" href="#chi-cun-bian-liang-xiu-gai"></a> \u5C3A\u5BF8\u53D8\u91CF\u4FEE\u6539</h2><p>\u5C3A\u5BF8\u53D8\u91CF\u4E0D\u518D\u4F7F\u7528<code>scss\u53D8\u91CF</code>\u65B9\u5F0F\uFF0C\u53D6\u800C\u4EE3\u4E4B\u7684\u662F <code>css var()</code>\u53D8\u91CF</p>`,3),au=n(" $md "),tu=n(" var(--md) ");function eu(b,i,B,h,F,m){const a=p("hl-tag"),d=p("hl-demo0"),g=p("demo-block"),l=p("TwoArrowRight"),r=p("hl-icon"),o=p("hl-group"),c=p("right-nav");return x(),v(D,null,[t("section",null,[w,z,q,u(a,{type:"danger",effect:"light",class:"border-none border-left border-danger m-b-sm",style:{"--border-left-width":"4px"}},{default:s(()=>[k]),_:1}),$,u(a,{type:"danger",effect:"light",class:"border-none border-left border-danger m-b-sm",style:{"--border-left-width":"4px"}},{default:s(()=>[V]),_:1}),S,u(a,{type:"danger",effect:"light",class:"border-none border-left border-danger m-b-sm",style:{"--border-left-width":"4px"}},{default:s(()=>[N]),_:1}),M,u(g,{"source-code":`<hl-button
  style="
    --button-radius: 8px;
    --button-padding-x: 20px;
    --button-padding-y: 4px;
