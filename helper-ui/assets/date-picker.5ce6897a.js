...
`},null,8,["demos"]),vt,ft,n(e,{fs:"",demos:v(a),"component-id":r,"path-name":"date-picker/daterange","source-code":`<template>
  <hl-row align="items-center" gap="var(--xl)">
...
const value2 = ref('')
<\/script>
`},{default:o(()=>[gt]),_:1},8,["demos"]),bt,Dt,n(e,{fs:"",demos:v(a),"component-id":r,"path-name":"date-picker/monthrange","source-code":`<template>
  <hl-row align="items-center" gap="var(--xl)">
    <hl-col span="lg:col-12">
      <p class="m-b-md">\u9ED8\u8BA4</p>
      <hl-date-picker
...
<\/script>
`},null,8,["demos"]),Ct]),n(d)],64)}}};export{zt as default};
