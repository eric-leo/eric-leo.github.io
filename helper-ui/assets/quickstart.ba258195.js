import{F as t,L as r,W as h,Q as s,X as n,P as p,a1 as o,M as a,o as e}from"./vue.d3316dca.js";import{_ as i}from"./index.ee32a861.js";import"./vendor.a3b1f0f2.js";import"./highlight.06dca650.js";import"./helper-icons.4adfdd39.js";const j={},u=s("h1",null,"\u5FEB\u901F\u4E0A\u624B",-1),d=s("p",null,"\u4ECB\u7ECD\u5982\u4F55\u5728\u9879\u76EE\u4E2D\u4F7F\u7528 Helper UI\u3002",-1),g=s("h2",{id:"yin-ru-helper-ui"},[s("a",{class:"header-anchor",href:"#yin-ru-helper-ui"}),a(" \u5F15\u5165 Helper UI")],-1),m=s("p",null,"\u4F60\u53EF\u4EE5\u5F15\u5165\u6574\u4E2A Helper UI\uFF0C\u6216\u662F\u6839\u636E\u9700\u8981\u4EC5\u5F15\u5165\u90E8\u5206\u7EC4\u4EF6\uFF0C\u6211\u4EEC\u5148\u4ECB\u7ECD\u5982\u4F55\u5F15\u5165\u5B8C\u6574\u7684 Helper UI Library\u3002",-1),f=s("h2",{id:"wan-zheng-yin-ru"},[s("a",{class:"header-anchor",href:"#wan-zheng-yin-ru"}),a(" \u5B8C\u6574\u5F15\u5165")],-1),y=s("p",null,"\u5728 main.ts \u4E2D\u5199\u5165\u4EE5\u4E0B\u5185\u5BB9\uFF1A",-1),_=a("main.ts"),w=e(`<pre><code class="hljs language-javascript"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>

<span class="hljs-keyword">import</span> <span class="hljs-title class_">HelperUI</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;helper-ui&#39;</span>; <span class="hljs-comment">//\u5F15\u5165Helper</span>
<span class="hljs-keyword">import</span> <span class="hljs-string">&#39;helper-ui/dist/index.css&#39;</span>;  <span class="hljs-comment">//\u5F15\u5165\u6837\u5F0F\u6587\u4EF6</span>
...
</code></pre><p>\u4EE5\u4E0A\u4EE3\u7801\u4FBF\u5B8C\u6210\u4E86 Helper UI \u7684\u5F15\u5165\uFF0C\u9700\u8981\u6CE8\u610F\u7684\u662F\u6837\u5F0F\u6587\u4EF6\u9700\u8981\u5355\u72EC\u5F15\u5165\u3002</p><h2 id="volar-support"><a class="header-anchor" href="#volar-support"></a> Volar support</h2><p>\u5982\u679C\u60A8\u4F7F\u7528 Volar\uFF0C\u8BF7\u5728 <code>tsconfig.json</code> \u4E2D\u901A\u8FC7 <code>compilerOptions.type</code> \u6307\u5B9A\u5168\u5C40\u7EC4\u4EF6\u7C7B\u578B\u3002</p>`,4),b=a("tsconfig.json"),k=e(`<pre><code class="hljs language-json"><span class="hljs-punctuation">{</span>
  <span class="hljs-attr">&quot;compilerOptions&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
    <span class="hljs-comment">// ...</span>
    <span class="hljs-attr">&quot;types&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">[</span><span class="hljs-string">&quot;helper-ui/global&quot;</span><span class="hljs-punctuation">]</span>
  <span class="hljs-punctuation">}</span>
<span class="hljs-punctuation">}</span>
</code></pre><h2 id="an-xu-yin-ru-zu-jian"><a class="header-anchor" href="#an-xu-yin-ru-zu-jian"></a> \u6309\u9700\u5F15\u5165\u7EC4\u4EF6</h2><p>HelperUI \u7684 JavaScript \u4EE3\u7801\u9ED8\u8BA4\u652F\u6301\u57FA\u4E8E ES modules \u7684 <a href="https://webpack.js.org/guides/tree-shaking/">\u6447\u6811 tree shaking</a>\u3002</p>`,3),v=a("app.vue"),x=e(`<pre><code class="hljs language-html"><span class="hljs-tag">&lt;<span class="hljs-name">template</span>&gt;</span>
...
<span class="hljs-keyword">import</span> { <span class="hljs-title class_">HlButton</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;helper-ui&#39;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">head</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">link</span> <span class="hljs-attr">rel</span>=<span class="hljs-string">&quot;stylesheet&quot;</span> <span class="hljs-attr">href</span>=<span class="hljs-string">&quot;//unpkg.com/helper-ui/dist/index.css&quot;</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">head</span>&gt;</span>
      ...
      <span class="hljs-attr">resolvers</span>: [
        ...
        <span class="hljs-function">(<span class="hljs-params">name</span>) =&gt;</span> {
          ...
          <span class="hljs-keyword">if</span> (name.<span class="hljs-title function_">startsWith</span>(<span class="hljs-string">&#39;Hl&#39;</span>))
            <span class="hljs-keyword">return</span> { <span class="hljs-attr">importName</span>: name, <span class="hljs-attr">path</span>: <span class="hljs-string">&#39;helper-ui&#39;</span> }
        }
      ]
    }),
  ],
...
</code></pre><p>\u7136\u540E\uFF0C\u5C06 babel.config.js \u4FEE\u6539\u4E3A\uFF1A</p><h4 id="yin-ru-.scss-yang-shi"><a class="header-anchor" href="#yin-ru-.scss-yang-shi"></a> \u5F15\u5165 <code>.scss</code> \u6837\u5F0F</h4><p>\u8BF7\u786E\u4FDD\u5DF2\u7ECF\u5B89\u88C5\u4E86 <code>sass</code> \u548C <code>sass-loader</code> \u4F9D\u8D56\u5E76\u5C06 <code>helper-ui/theme/scss/base.scss</code> \u6587\u4EF6\u5728\u5165\u53E3\u6587\u4EF6\u4E2D\u5F15\u5165</p><pre><code class="hljs language-js"><span class="hljs-variable language_">module</span>.<span class="hljs-property">exports</span> = {
  <span class="hljs-attr">plugins</span>: [
    [
      <span class="hljs-string">&quot;import&quot;</span>,
      {
        <span class="hljs-attr">libraryName</span>: <span class="hljs-string">&#39;helper-ui&#39;</span>,
        <span class="hljs-attr">customStyleName</span>: <span class="hljs-function">(<span class="hljs-params">name</span>) =&gt;</span> {
          ...
          <span class="hljs-keyword">return</span> <span class="hljs-string">\`helper-ui/theme/scss/<span class="hljs-subst">\${name}</span>.scss\`</span>;
        },
      },
    ],
  ],
  ...
  <span class="hljs-attr">plugins</span>: [
    [
      <span class="hljs-string">&quot;import&quot;</span>,
      {
        <span class="hljs-attr">libraryName</span>: <span class="hljs-string">&#39;helper-ui&#39;</span>,
        <span class="hljs-attr">customStyleName</span>: <span class="hljs-function">(<span class="hljs-params">name</span>) =&gt;</span> {
          <span class="hljs-keyword">return</span> <span class="hljs-string">\`helper-ui/theme/<span class="hljs-subst">\${name}</span>.css\`</span>;
        },
      },
    ],
  ],
...
</code></pre><p>\u7136\u540E\uFF0C\u5C06 vite.config.js \u4FEE\u6539\u4E3A\uFF1A</p><h4 id="yin-ru-.scss-yang-shi-2"><a class="header-anchor" href="#yin-ru-.scss-yang-shi-2"></a> \u5F15\u5165 <code>.scss</code> \u6837\u5F0F</h4><p>\u8BF7\u786E\u4FDD\u5DF2\u7ECF\u5B89\u88C5\u4E86 <code>sass</code> \u4F9D\u8D56\u5E76\u5C06 <code>helper-ui/theme/scss/base.scss</code> \u6587\u4EF6\u5728\u5165\u53E3\u6587\u4EF6\u4E2D\u5F15\u5165</p><pre><code class="hljs language-js"><span class="hljs-keyword">import</span> { defineConfig } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vite&#39;</span>
    ...
    <span class="hljs-title function_">styleImport</span>({
      <span class="hljs-attr">libs</span>: [{
        ...
        <span class="hljs-attr">resolveComponent</span>: <span class="hljs-function">(<span class="hljs-params">name</span>) =&gt;</span> {
          <span class="hljs-keyword">return</span> <span class="hljs-string">\`helper-ui/lib/<span class="hljs-subst">\${name}</span>\`</span>;
        },
      }]
    })
  ]
})
</code></pre><h4 id="huo-zhe-yin-ru-.css-yang-shi-2"><a class="header-anchor" href="#huo-zhe-yin-ru-.css-yang-shi-2"></a> \u6216\u8005\u5F15\u5165 <code>.css</code> \u6837\u5F0F</h4><p>\u8BF7\u786E\u4FDD <code>helper-ui/theme/base.css</code> \u6587\u4EF6\u5728\u5165\u53E3\u6587\u4EF6\u4E2D\u5F15\u5165</p><pre><code class="hljs language-js"><span class="hljs-keyword">import</span> { defineConfig } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vite&#39;</span>
<span class="hljs-keyword">import</span> vue <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;@vitejs/plugin-vue&#39;</span>
<span class="hljs-keyword">import</span> styleImport <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vite-plugin-style-import&#39;</span>
...
<span class="hljs-keyword">import</span> { <span class="hljs-title class_">HlButton</span>, <span class="hljs-title class_">HlSelect</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;helper-ui&#39;</span>;
<span class="hljs-keyword">import</span> <span class="hljs-title class_">App</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;./App.vue&#39;</span>;
<span class="hljs-comment">// \u5982\u679C\u8981\u4F7F\u7528.scss\u6837\u5F0F\u6587\u4EF6\uFF0C\u5219\u9700\u8981\u5F15\u5165base.scss\u6587\u4EF6</span>
<span class="hljs-comment">// import &#39;helper-ui/theme/scss/base.scss&#39;</span>

<span class="hljs-comment">// \u5982\u679C\u8981\u4F7F\u7528.css\u6837\u5F0F\u6587\u4EF6\uFF0C\u5219\u9700\u8981\u5F15\u5165base.css\u6587\u4EF6</span>
<span class="hljs-comment">// import &#39;helper-ui/theme/base.css&#39;</span>
...
app.<span class="hljs-title function_">mount</span>(<span class="hljs-string">&#39;#app&#39;</span>)
</code></pre><h2 id="quan-ju-pei-zhi"><a class="header-anchor" href="#quan-ju-pei-zhi"></a> \u5168\u5C40\u914D\u7F6E</h2><p>\u5728\u5F15\u5165 Helper UI \u65F6\uFF0C\u53EF\u4EE5\u4F20\u5165\u4E00\u4E2A\u5168\u5C40\u914D\u7F6E\u5BF9\u8C61\u3002\u8BE5\u5BF9\u8C61\u76EE\u524D\u652F\u6301 <code>size</code>\u3001<code>zIndex</code> \u4E0E <code>systemIcons</code> \u5B57\u6BB5\u3002<code>size(xs/sm/md/lg)</code> \u7528\u4E8E\u6539\u53D8\u7EC4\u4EF6\u7684\u9ED8\u8BA4\u5C3A\u5BF8\uFF0C<code>zIndex</code> \u8BBE\u7F6E\u5F39\u6846\u7684\u521D\u59CB z-index\uFF08\u9ED8\u8BA4\u503C\uFF1A2000\uFF09\uFF0C<code>systemIcons</code> \u7528\u4E8E\u5B9A\u5236\u7CFB\u7EDF\u9ED8\u8BA4\u56FE\u6807\uFF0C\u5177\u4F53\u65B9\u5F0F\u8BF7\u53C2\u8003Icon\u6587\u6863\u3002\u6309\u9700\u5F15\u5165 Helper UI \u7684\u65B9\u5F0F\uFF0C\u5177\u4F53\u64CD\u4F5C\u5982\u4E0B\uFF1A</p><h4 id="wan-zheng-yin-ru-helper-ui"><a class="header-anchor" href="#wan-zheng-yin-ru-helper-ui"></a> \u5B8C\u6574\u5F15\u5165 Helper UI\uFF1A</h4><pre><code class="hljs language-js"><span class="hljs-keyword">import</span> { createApp, h } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
<span class="hljs-keyword">import</span> <span class="hljs-title class_">HelperUI</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;helper-ui&#39;</span>;
<span class="hljs-keyword">import</span> <span class="hljs-title class_">App</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;./App.vue&#39;</span>;
...
</code></pre><h4 id="an-xu-yin-ru-helper-ui"><a class="header-anchor" href="#an-xu-yin-ru-helper-ui"></a> \u6309\u9700\u5F15\u5165 Helper UI\uFF1A</h4><pre><code class="hljs language-ts">&lt;template&gt;
...
<span class="hljs-keyword">import</span> { defineComponent } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
<span class="hljs-keyword">import</span> { <span class="hljs-title class_">HlConfigProvider</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;helper-ui&#39;</span>
