...
<\/script>
`},{default:c(()=>[B]),_:1},8,["demos"]),I,N,n(e,{fs:"",demos:u(d),"component-id":l,"path-name":"switch/size","source-code":`<template>
...
<script lang="ts" setup>
import { ref } from 'vue'
import { TwoMail, TwoPower, TwoAirplay } from '@helper-ui/icons'
