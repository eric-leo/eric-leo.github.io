...
<\/script>
`},{default:d(()=>[tt]),_:1},8,["demos"]),et,l(n,{fs:"",demos:m(o),"component-id":f,"path-name":"transfer/show-buttons","source-code":`<template>
  <hl-transfer
    v-model="value"
...
const value = ref([1, 4])
<\/script>
`},{default:d(()=>[nt]),_:1},8,["demos"]),dt,lt,l(n,{fs:"",demos:m(o),"component-id":f,"path-name":"transfer/filterable","source-code":`<template>
  <hl-transfer
    v-model="value"
    filterable
...
<\/script>
`},{default:d(()=>[at]),_:1},8,["demos"]),ot,rt,l(n,{fs:"",demos:m(o),"component-id":f,"path-name":"transfer/slot","source-code":`<template>
  <hl-row>
...
<script lang="ts" setup>
import { ref } from 'vue'
import { TwoFolderIn, TwoDelete } from '@helper-ui/icons'
...
`},{default:d(()=>[st]),_:1},8,["demos"]),ut,ct,l(n,{fs:"",demos:m(o),"component-id":f,"path-name":"transfer/props","source-code":`<template>
  <hl-transfer
    v-model="value"
    :props="{
      key: 'value',
...
<\/script>
`},{default:d(()=>[ht]),_:1},8,["demos"]),it]),l(r)],64)}}};export{mt as default};
