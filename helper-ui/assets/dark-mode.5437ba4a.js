import{F as s,L as p,W as o,Q as a,X as n,P as t,a1 as r,M as l,o as h}from"./vue.d3316dca.js";import{_ as m}from"./index.ee32a861.js";import"./vendor.a3b1f0f2.js";import"./highlight.06dca650.js";import"./helper-icons.4adfdd39.js";const d={},i=l("\u6697\u9ED1\u6A21\u5F0F"),g=l("2.2.0"),j=h(`<p>\u6211\u4EEC\u63D0\u53D6\u5E76\u6574\u7406\u4E86\u6240\u6709\u7684\u8BBE\u8BA1\u53D8\u91CF\uFF0C\u5E76\u901A\u8FC7 CSS Vars \u6280\u672F\u5B9E\u73B0\u52A8\u6001\u66F4\u65B0\u4E3B\u9898\u3002</p><h2 id="ru-he-qi-yong"><a class="header-anchor" href="#ru-he-qi-yong"></a> \u5982\u4F55\u542F\u7528\uFF1F</h2><p>\u9996\u5148\u4F60\u53EF\u4EE5\u521B\u5EFA\u4E00\u4E2A\u5F00\u5173\u6765\u63A7\u5236 <code>\u6697\u9ED1\u6A21\u5F0F</code> \u7684 class \u7C7B\u540D\u3002</p><blockquote><p>\u5982\u679C\u60A8\u53EA\u9700\u8981\u6697\u8272\u6A21\u5F0F\uFF0C\u53EA\u9700\u5728 html \u4E0A\u6DFB\u52A0\u4E00\u4E2A\u540D\u4E3A <code>dark-mode</code> \u7684\u7C7B \u3002</p></blockquote><pre><code class="hljs language-html"><span class="hljs-tag">&lt;<span class="hljs-name">html</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;dark-mode&quot;</span>&gt;</span>
...
<span class="hljs-keyword">import</span> <span class="hljs-string">&#39;helper-ui/theme/dark/colors.css&#39;</span>
...
</code></pre><p>\u5728 Helper UI \u7684\u6837\u5F0F\u4E4B\u540E\u5BFC\u5165\u5B83:</p><pre><code class="hljs language-ts"><span class="hljs-comment">// main.ts</span>
<span class="hljs-keyword">import</span> <span class="hljs-string">&#39;helper-ui/theme/dark/colors.css&#39;</span>
...
<span class="hljs-comment">/* \u8986\u76D6\u4F60\u9700\u8981\u7684\u53D8\u91CF\uFF0C\u53C2\u8003Helper-ui/theme/scss/common/colors.scss\u4E2D\u5B9A\u4E49\u7684\u989C\u8272 */</span>
...
<span class="hljs-comment">// index.scss\u4E00\u5B9A\u8981\u5728\u5F15\u5165Helper-ui\u7684index.scss\u4E4B\u524D\u5F15\u5165</span>
...
<span class="hljs-comment">// import &#39;helper-ui/theme/src/dark/colors.scss&#39;</span>
</code></pre>`,19);function u(_,k){const e=s("hl-tag"),c=s("right-nav");return p(),o(r,null,[a("section",null,[a("h1",null,[i,n(e,{type:"primary",size:"sm",class:"m-l-xs"},{default:t(()=>[g]),_:1})]),j]),n(c)],64)}var S=m(d,[["render",u]]);export{S as default};
